...
`;
export const TheadName = styled.div`
...
export const TNameImg = styled.img`
  ...
  margin-right: 10px;
`;
export const TRowName = styled.div`
  color: #676767;
  letter-spacing: 0.01em;
  display: flex;
  align-items: center;
...
export const StatusItem = styled.div`
  ...
  height: 30px;
  background: ${(props) =>
    props.bg ? "rgba(0, 194, 113, 0.08)" : "rgba(255, 0, 0, 0.08)"};
  border-radius: 65px;
  display: flex;
  justify-content: center;
  align-items: center;
...
export const MarkItem = styled.div`
  ...
  background-color: #fff;
`;
export const MarkTop = styled.div`
  height: 14px;
...
export const MarkMiddle = styled.div`
  ...
  padding: 25px 0;
`;
export const MarkBottom = styled.div`
  height: 14px;
...
export const TblOut = styled.div`
  overflow-x: auto;
`;
export const ResBack = styled.div`
